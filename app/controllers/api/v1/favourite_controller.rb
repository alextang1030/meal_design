class Api::V1::FavouriteController < Api::ApiController
	...
	def list
		...
		render json: self.response_array(0,"",@user.fav_lists.map{ |fav|
			self.return_restaurant(fav.restaurant)
		})
	end
	...
	def add
		...
		if fav.valid?
			...
			render json: self.response_array(1,fav.errors.full_messages[0],{})
			return
		end
		
		render json: self.response_array(0,"",self.return_restaurant(fav.restaurant))
